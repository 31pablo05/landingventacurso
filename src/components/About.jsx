  ...
  return (
    <section className="section-padding bg-white relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto text-center relative z-10 px-4 sm:px-6">
        <motion.h2 
          className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-title font-bold text-[#0077B6] mb-6 sm:mb-8"
        ...
        >
          <p className="text-base sm:text-lg md:text-xl text-[#0A0A0A] leading-relaxed font-body mb-4 sm:mb-6">
          ...
          <p className="text-base sm:text-lg md:text-xl text-[#0A0A0A] leading-relaxed font-body">
        ...
        {/* Stats */}
        <motion.div 
          className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4 md:gap-6 mt-8 sm:mt-12"
          initial={{ opacity: 0, y: 30 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
        ...
        >
          {[
            ...
            <motion.div
              key={index}
              className="bg-gradient-to-br from-[#90E0EF] to-white p-4 sm:p-6 rounded-lg sm:rounded-xl shadow-lg border border-[#00B4D8] border-opacity-20"
              whileHover={{ 
                scale: 1.05,
            ...
            >
              <div className="text-2xl sm:text-3xl md:text-4xl font-bold text-[#0077B6] mb-1 sm:mb-2">
                {stat.number}
              </div>
              <div className="text-xs sm:text-sm md:text-base text-[#0A0A0A] font-body">
                {stat.label}
              </div>
            </motion.div>
          ))}
